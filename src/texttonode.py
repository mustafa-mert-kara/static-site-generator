...
#                 new_nodes.append(TextNode(images[i-1][0],TextType.IMAGE,images[i-1][1]))
#                 image_split=split_nodes[i].split(")")[1]
#                 if image_split!='':
#                     new_nodes.append(TextNode(image_split,TextType.TEXT))
#     return new_nodes
