...
class TestTextNode(unittest.TestCase):
    ...
    def test_text_to_node(self):
        ...
        node_list=text_to_textnode(text)
        self.assertListEqual([
    ...
    def test_text_to_node2(self):
        text="This **is** **text** with an _italic_ word and a `code block` and an ![obi wan image](https://i.imgur.com/fJRm4Vk.jpeg) and a [link](https://boot.dev) and another _italic_"
        node_list=text_to_textnode(text)
        self.assertListEqual([
